...
## 2026-09-06/07 — Per-parcel overlay document retrieval, Tier 1 (PSL/PST/PSZAE/PSP)
...
**Remaining Tier 1:** Flood HQ20/HQ100 (needs resolving a PDF-binary-fetch problem for the PGRI document — not yet solved) and the Findel servitude RGD (exact Legilux URL not yet directly verified, only a secondary government page found so far).
